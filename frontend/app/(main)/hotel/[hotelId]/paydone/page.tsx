...
export default function PayPage() {
  return (
    <main className='container my-10 lg:mb-32 '>
      <div className='max-w-4xl mx-auto'>
        <div className='w-full flex flex-col sm:rounded-2xl space-y-10 px-0 sm:p-6 xl:p-8'>
          ...
          <div className='space-y-6'>
            ...
            <div className='mt-6 border border-neutral-200 dark:border-neutral-700 rounded-xl flex flex-col sm:flex-row divide-y sm:divide-x sm:divide-y-0 divide-neutral-200 dark:divide-neutral-700'>
